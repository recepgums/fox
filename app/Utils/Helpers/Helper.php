...
class Helper
{
  ...
  public static function namedSettings($settings)
  {
    ...
    public static function all_posts(){
      ...
      $data = Post::where('type','post')->where('status',1)->where('user_id',$admin->id)->orderBy('created_at','desc')->get();
      return $data;
    }
    ...
    public static function recentPosts($limit){
        $admin = User::where('role','admin')->first();
        return Post::where('type','post')->where('status',1)->where('user_id',$admin->id)->orderBy('created_at','desc')->limit($limit)->get();
    }
    ...
    public static function canVotePartner($partnerId){
        $data = Comment::where('user_id',\auth()->user()->id)->where('partner_id',$partnerId)->first();
    ...
    public static function getAllBlogs2(){
        $admin= User::where('role','admin')->first();
          return Post::where('type','post')->where('user_id',$admin->id)->get();
    }
