    ...
    <div id="data-list-list-view" class="data-list-container">
        ...
        <vs-table ref="table"  multiple v-model="selected" pagination :max-items="itemsPerPage" search :data="DataList">
            ...
            <template slot-scope="{data}">
                <tbody>
                <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data" v-if="tr.FormData.indexOf(getUserId.id)>0">
                    <vs-td>
...
<script>
    import DataViewSidebar from '../../admin/content/form/DataViewSidebar.vue'
