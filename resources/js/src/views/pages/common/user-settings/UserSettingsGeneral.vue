...
<!--    </vs-alert>-->
    ...
    <vs-input class="w-full my-base" :label-placeholder="$t('Location')" name="address" v-model="currentUserData.address"></vs-input>
      <vs-textarea label="Full Address" name="bill_address" v-model="currentUserData.bill_address" placeholder="Full Address..." />
    <!-- Save & Reset Button -->
