            ...
            <div class="row">
                <div class="cell-8">
                                    ...
                                    @foreach($comments as $comment)
                                        ...
                                        <article class="comment">
                                            ...
                                            <div class="comment-content">
                                                ...
                                                <p>
                                                   @isset($comment->content) {{$comment->content}}@endisset
                                                </p>
                                            </div>
                                        </article>
                                        @isset($childComment)
                    ...
                    @guest
                        ...
                        <a href="/panel/login" onclick="setCookie('blogUrl',window.location.href)" class="btn btn-danger"> {{__('lang.please_login')}}</a>
                    @endguest
                    @auth
                        ...
                        <li class="widget r-posts-w fx" data-animate="fadeInRight">
                            ...
                            <div class="widget-content">
                                <div class="cell-12 contact-form fx" data-animate="fadeInLeft" id="contact">
                                    ...
                                    <form class="form-signin cform" method="post" action="{{route('contact.partnerContact')}}"
                                          id="cform"
                                          autocomplete="on">
                                        @csrf
