...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    if (js_cookie__WEBPACK_IMPORTED_MODULE_1___default.a.get('refresh')) {
      js_cookie__WEBPACK_IMPORTED_MODULE_1___default.a.remove('refresh');
      location.reload();
    } else {
      js_cookie__WEBPACK_IMPORTED_MODULE_1___default.a.set('refresh', 'aaa');
    }
  ...
  methods: {
    ...
    login: function login() {
      ...
      this.$store.dispatch('auth/login', payload).then(function (response) {
        var cokkieUrl = _this.getCookie('blogUrl');

        if (cokkieUrl) {
          document.cookie = 'blogUrl' + '=; Path=/; Expires=Thu, 01 Jan 1970 00:00:01 GMT;';
          window.location.href = cokkieUrl;
        }
