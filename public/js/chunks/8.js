...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    activeUser: function activeUser() {
      return js_cookie__WEBPACK_IMPORTED_MODULE_12___default.a.get('user') ? JSON.parse(js_cookie__WEBPACK_IMPORTED_MODULE_12___default.a.get('user')) : null; // return this.$store.state.auth.user
    }
  },
  created: function created() {
  ...
  methods: {
    save_changes: function save_changes() {
      ...
      var payload = {
        ...
        bill_address: this.currentUserData.bill_address,
        avatar: this.avatar
      };
      this.$store.dispatch('user/updateUser', payload).then(function (response) {
        _this2.$vs.loading.close();
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    appendData: function appendData() {
      console.log(JSON.parse(this.user.about_data));
      this.bio = JSON.parse(this.user.about_data).bio;
      ...
      this.tags = JSON.parse(this.user.about_data).tags;
    },
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _c("vs-input", {
        staticClass: "w-full",
        attrs: { "label-placeholder": _vm.$t("phone"), name: "phone" },
        model: {
      ...
      _c("vs-input", {
        ...
        attrs: { "label-placeholder": _vm.$t("Location"), name: "address" },
        model: {
      ...
      _c("vs-textarea", {
        ...
        model: {
          value: _vm.currentUserData.bill_address,
          callback: function($$v) {
            _vm.$set(_vm.currentUserData, "bill_address", $$v)
          },
          expression: "currentUserData.bill_address"
        }
      }),
      _vm._v(" "),
      _c(
