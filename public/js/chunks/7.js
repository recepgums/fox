...
var VxTour = function VxTour() {
  return __webpack_require__.e(/*! import() */ 24).then(__webpack_require__.bind(null, /*! @/components/VxTour.vue */ "./resources/js/src/components/VxTour.vue"));
};
...
}, //user
{
  ...
  submenu: [{
    ...
    url: '/panel/contact-requestes',
    slug: '/panel/contact-requestes',
    name: 'blog-posts',
    icon: 'FileTextIcon',
    i18n: 'contactRequest'
  }]
