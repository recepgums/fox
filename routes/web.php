...
Route::group(['middleware' => 'web'], function () {
    ...
    Route::get('/country/{name}', [PageController::class, 'pageView'])->name('service.find');
    Route::get('/tour/{name}', [PageController::class, 'pageView'])->name('tour.find');
    ...
    Route::post('/ajax/contact-partner', [ApiAppointmentController::class, 'partnerContact'])->name('contact.partnerContact');
    ...
    Route::get('/ajax/sitemap', [PageController::class, 'sitemap'])->name('sitemap');
